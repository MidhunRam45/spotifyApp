...
function SongCart({
  ...
  const isInclude =
    favData && favData?.some((value: any) => value.track.id === id);
    ...
    <div className="cart">
      <div className="image-container">
        {imagesrc ? (
          ...
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSt5HwsaeGatj563CgNZDgJuKf36FuJc-wpA&usqp=CAU" />
        )}
        ...
        >
          {/* {currentlyPlaying === id && Playing === true ? (
